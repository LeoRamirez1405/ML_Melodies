...
mkdir -p $CURRENT_DIR/corpus/MAESTRO-V3/mp3
...
python3 $CURRENT_DIR/corpus/conv_wav2fe.py -d_list $CURRENT_DIR/corpus/MAESTRO-V3/list -d_mp3 $CURRENT_DIR/corpus/MAESTRO-V3/mp3 -d_feature $CURRENT_DIR/corpus/MAESTRO-V3/feature -config $CURRENT_DIR/corpus/config.json
...
python3 $CURRENT_DIR/corpus/make_dataset.py -f_config_in $CURRENT_DIR/corpus/config.json -f_config_out $CURRENT_DIR/corpus/MAESTRO-V3/dataset/config.json -d_dataset $CURRENT_DIR/corpus/MAESTRO-V3/dataset -d_list $CURRENT_DIR/corpus/MAESTRO-V3/list -d_feature $CURRENT_DIR/corpus/MAESTRO-V3/feature -d_label $CURRENT_DIR/corpus/MAESTRO-V3/label -n_div_train 1 -n_div_valid 1 -n_div_test 1
