...
# python3 $CURRENT_DIR/corpus/conv_wav2fe.py -d_list $CURRENT_DIR/corpus/GUITAR-V0/list -d_mp3 $CURRENT_DIR/corpus/GUITAR-V0/mp3 -d_feature $CURRENT_DIR/corpus/GUITAR-V0/feature -config $CURRENT_DIR/corpus/config.json

# # 5. convert midi to note
# mkdir -p $CURRENT_DIR/corpus/GUITAR-V0/note
# python3 $CURRENT_DIR/corpus/conv_midi2note.py -d_list $CURRENT_DIR/corpus/GUITAR-V0/list -d_midi $CURRENT_DIR/corpus/GUITAR-V0/midi -d_note $CURRENT_DIR/corpus/GUITAR-V0/note -config $CURRENT_DIR/corpus/config.json

# # 6. convert note to label
# mkdir -p $CURRENT_DIR/corpus/GUITAR-V0/label
# python3 $CURRENT_DIR/corpus/conv_note2label.py -d_list $CURRENT_DIR/corpus/GUITAR-V0/list -d_note $CURRENT_DIR/corpus/GUITAR-V0/note -d_label $CURRENT_DIR/corpus/GUITAR-V0/label -config $CURRENT_DIR/corpus/config.json
