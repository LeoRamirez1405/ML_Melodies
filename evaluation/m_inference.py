...
if __name__ == '__main__':
    ...
    parser.add_argument('-f_list', help='file list', default='../corpus/MAESTRO-V3/list/testLeo.list')
    ...
    parser.add_argument('-d_mp3', help='corpus mp3 directory', default='../corpus/MAESTRO-V3/mp3')
