...
if __name__ == '__main__':
    ...
    parser.add_argument('-d_cp', help='checkpoint directory')
    parser.add_argument('-m', help='input model file')
    parser.add_argument('-mode', help='mode to transcript (combination|single)')
    parser.add_argument('-d_mp3', help='corpus mp3 directory')
    parser.add_argument('-d_fe', help='corpus feature directory')
    parser.add_argument('-d_mpe', help='output directory for .mpe')
    parser.add_argument('-d_note', help='output directory for .json')
